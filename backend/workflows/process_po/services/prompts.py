...
actor_prompt_template = ChatPromptTemplate.from_messages([
    (
        ...
        **Instructions for Extraction:**
        ...
        5. The **postal_code** is the postal code of the delivery address. It's generally 7 digits alphanumeric in nature and appears in the delivery address.
        6. The **company_name** is the name of the external company that *generated* or *sent* this PDF document (e.g., the supplier of the products or the customer who issued a PO). **This company name must NOT be 'Zeus Packaging' or any variation of Zeus's own company name**. **You must always provide a value for company_name. If you cannot find it, return an empty string.**
        ...
        **Strict JSON Output Format (adhere precisely to this structure and data types):**
        ...
        {{
            ...
            "postal_code": "postal code of the delivery address, generally 7 digit alphanumeric in nature, appears in delivery address",
            ...
            "product_details": [
                {{
                    ...
                    "company_name": "Name of the company who generated the purchase order (can never be zeus packaging)"
                }},
                {{
