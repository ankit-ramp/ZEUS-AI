...
def save_dataframe_to_excel(state):
    ...
    df = df[["Customer Ref", "Delivery reference", "delivery_address", "postal_code", "customer_order_number", "stock_code", "product_quantity", "unit_price", "product_value", "product_name", "company_name", "customer_product_code", "file_name"]]
